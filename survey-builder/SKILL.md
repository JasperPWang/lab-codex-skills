...
- Before building or revising a literature survey, literature tree, novelty tree, or challenge-insight tree for the user's research wiki, use the user's Feishu method page as the canonical example unless a more specific template is provided: `如何构建literature tree（如何进行literature review，构建novelty tree和challenge-insight tree）`, https://gxt1fwqtrod.feishu.cn/wiki/TbpBwmANXiXKQVkr38scb1tKnpq, doc token `LC0WdpnZ3oUHjCxAWipcWvYSnac`.
